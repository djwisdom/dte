...
const Command *find_normal_command(const char *name) NONNULL_ARGS WARN_UNUSED_RESULT;
const char *find_normal_alias(const struct EditorState *e, const char *name) NONNULL_ARGS WARN_UNUSED_RESULT;
